...
import { Cooperation, Produktteaser, Image, ImageBox } from "./styles/Home.styles";
...
const HomePage: React.FC = () => {
  ...
  const getConfig = (scrollTop: number, threshold: number): HomePageConfig => {
    ...
    const backgroundColor = `rgb(${progress * 255}, ${progress * 255}, ${progress * 255})`;
    const textColor = `rgb(${255 - progress * 255}, ${255 - progress * 255}, ${255 - progress * 255})`;
    return {
      backgroundColor,
      textColor
    };
